...
/**
 * This is an extension of the MgfFileIterator class from the compomics-utilities library.
 * The code of JMgfFileIterator is adopted from the MgfFileIterator class from the compomics-utilities library.
 */
public class JMgfFileIterator implements MsFileIterator {
     ...
     */
    private JSpectrum spectrum = null;
     ...
     */
    public JMgfFileIterator(File mgfFile, WaitingHandler waitingHandler) {
    ...
    public String next() {
        ...
        while ((line = reader.readLine()) != null && !waitingHandler.isRunCanceled()) {
            ...
            if (line.startsWith("BEGIN IONS")) {
                ...
                // Ignore
                scan = Integer.parseInt(line.split("=")[1]);
            } else if (line.startsWith("TAG")) {
                // sequence tag not implemented
                ...
                spectrum = new JSpectrum(precursor, mzArray, intensityArray);
                spectrum.title = spectrumTitle;
                spectrum.SEQ = SEQ;
                spectrum.SCANS = scan;
